...
| Skill | Description |
|-------|-------------|
| [pensar-attack-surface](skills/pensar-attack-surface/) | Curate a workspace's attack surface with the Pensar Apex CLI — consolidate duplicate applications, move endpoints between apps, rewrite testing objectives and threat models, and add what recon missed |
